...
<StatRow>
<Stat number="$37K+" label="lost annually from one gap per team per week" />
<Stat number="30%" label="drop in retention after one missed appointment" />
<Stat number="$3,500" label="average cost to replace one cleaner" />
</StatRow>
...
<InlineCTA title="Stop Losing Clients to Scheduling Mistakes" description="Spotless prevents double bookings, sends automatic reminders, and keeps your teams on track." href="/product/scheduling" label="See Scheduling Features" />
...
Not every cleaner can handle every job. Some are trained for carpet cleaning or window washing. Others excel at detailed kitchen work. Some are experienced with high-end properties where the stakes are higher.
...
<InlineCTA title="Manage Your Team in One Place" description="Track availability, assign skills, and let staff update their own schedules — no more 6am text messages." href="/product/staff-management" label="See Staff Management" />
...
<InlineCTA title="Automate the Busywork" description="From reminders to invoices to review requests — set it once and let Spotless handle the rest." href="/product/automations" label="See Automations" />

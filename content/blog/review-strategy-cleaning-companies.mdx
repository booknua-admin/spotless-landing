...
If you are not actively building a review generation system, you are leaving money and market share on the table.

<StatRow>
<Stat number="87%" label="of consumers read online reviews" />
<Stat number="4.7+" label="star average needed to rank in local top 3" />
<Stat number="15–25%" label="healthy review request response rate" />
<Stat number="10x" label="more trust than paid ads" />
</StatRow>
...
<InlineCTA title="Automate Your Review Funnel" description="Set up smart review requests that trigger after every job — no manual follow-up needed." href="/product/referrals-reviews" label="See Reviews & Referrals" />
...
<InlineCTA title="Build Workflows That Run Themselves" description="Automate review requests, follow-ups, and referral triggers after every completed job." href="/product/automations" label="See Automations" />
...
<InlineCTA title="Price With Confidence" description="Use data-driven pricing so every job is profitable — and clients see the value." href="/tools/pricing-calculator" label="Try the Pricing Calculator" />

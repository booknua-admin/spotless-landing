...
**Phase 1: Build your core.** Get your own operations running smoothly first. No partnership will succeed if you cannot deliver quality consistently. This is where solid [payment systems](/product/payments) and operational tools matter — your partners need to see a professional operation.

**Phase 2: Start with one partnership.** Pick the highest-potential opportunity and make it work. Learn the process of managing a partnership before adding more.

**Phase 3: Add complementary partners.** Once you have a working model, add 2 to 3 more partners in non-overlapping service areas. Each new partnership should fill a different gap.

**Phase 4: Systematize.** Create a partnership playbook — standard agreements, onboarding processes, tracking systems, and review cadences. This lets you add new partners efficiently.

**Phase 5: Leverage.** Use your partnership network as a competitive advantage. When a commercial prospect asks if you handle carpet, windows, and janitorial, you can say yes — even if you only directly provide one of those services.

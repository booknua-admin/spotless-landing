...
<InlineCTA title="Manage Your Growing Team" description="Track schedules, performance, and availability for every team member in one place." href="/product/staff-management" label="See Staff Management" />
...
A proper scheduling system saves the average cleaning business owner 8 to 12 hours per week in coordination time. That is an entire working day you get back.

<StatRow>
<Stat number="8-12 hrs" label="saved per week with scheduling software" />
<Stat number="200-400%" label="average annual turnover in cleaning industry" />
<Stat number="$3,000" label="cost to replace one cleaner (recruiting + training)" />
</StatRow>
...
<InlineCTA title="Turn Happy Clients Into Referrals" description="Automate your referral program and review requests to grow on autopilot." href="/product/referrals-reviews" label="See Referrals & Reviews" />
...
A good team lead is worth their weight in gold. Invest in them. Pay them well. Give them authority. They are the bridge between you and your cleaning staff.
...
<InlineCTA title="Automate Your Operations" description="From booking confirmations to follow-up surveys, let automations handle the busywork so you can focus on growth." href="/product/automations" label="See Automations" />

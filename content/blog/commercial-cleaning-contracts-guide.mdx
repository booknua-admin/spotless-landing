...
<StatRow>
<Stat number="$100B+" label="U.S. commercial cleaning market" />
<Stat number="80%" label="industry avg. contract renewal rate" />
<Stat number="1 contract" label="can equal 20+ residential clients" />
</StatRow>
...
<InlineCTA title="Price Your Commercial Bids Right" description="Calculate per-square-foot pricing with built-in labour, supply, and overhead costs." href="/tools/pricing-calculator" label="Try the Pricing Calculator" />
...
**Current pain points.** Ask what the facility manager hates about their current service. This is gold — it tells you exactly where to differentiate your proposal. If they complain about restroom quality, emphasize your restroom protocols. If they are frustrated by poor communication, lead with your reporting cadence.
...
<InlineCTA title="Automate Invoicing and Payments" description="Send invoices automatically and get paid on time — no more chasing checks." href="/product/payments" label="See Payments" />
...
<InlineCTA title="Track Profitability Per Account" description="See exactly which contracts make money and which ones need renegotiation." href="/product/finance" label="See Financial Tools" />

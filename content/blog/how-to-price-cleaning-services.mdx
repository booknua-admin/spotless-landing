...
> **Calculate Your Ideal Pricing:** Stop guessing. Use our free pricing calculator to set rates based on your real costs and target margins. [Try the Pricing Calculator](/tools/pricing-calculator)
...
- **30-50%** — how much owners underestimate their true costs
- **$58** — minimum hourly rate for $50K take-home
- **25-30%** — of revenue should be reserved for taxes
...
> **Automate Recurring Billing:** Set frequency discounts once and let Spotless handle invoicing and payment collection on autopilot. [See Payments](/product/payments)
...
The key to selling [add-ons](/glossary/upsell) is making them visible at the point of booking. When clients see a clear menu of options with fixed prices, they add services they would never think to ask about. Your online booking system should list these options so clients can self-select.
...
> **Check Your Profit Margins:** Are you actually making money on every job? Our free calculator shows your real margins after all costs. [Try the Margin Calculator](/tools/profit-margin-calculator)

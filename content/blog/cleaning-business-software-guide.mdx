...
<StatRow>
<Stat number="10-15 hrs" label="per week lost to manual admin" />
<Stat number="$23K+" label="in annual lost revenue from admin time" />
<Stat number="60-80%" label="admin time reduction with software" />
</StatRow>
...
<InlineCTA title="See Scheduling in Action" description="Drag-and-drop scheduling, automated reminders, and real-time job tracking built for cleaning businesses." href="/product/scheduling" label="Explore Scheduling" />
...
<InlineCTA title="Automate the Busywork" description="Booking confirmations, reminders, follow-ups, and review requests — all on autopilot." href="/product/automations" label="See Automations" />
...
<InlineCTA title="See Plans and Pricing" description="Find the right plan for your cleaning business — from solo operator to multi-team operation." href="/pricing" label="View Pricing" />
